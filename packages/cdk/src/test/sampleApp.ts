...
import { ApiViewBase, ApiEvent, ApiResponse, ApiView, Lambda, SubRoute, apiViewHandler } from "@jetkit/cdk-runtime"
 ...
 * @internal
 */
export const handler = apiViewHandler("sampleApp.ts", AlbumApi)
